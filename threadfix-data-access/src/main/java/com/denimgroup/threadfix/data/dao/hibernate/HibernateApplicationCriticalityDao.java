 ...
 */
@Repository
public class HibernateApplicationCriticalityDao
        extends AbstractNamedObjectDao<ApplicationCriticality>
        implements ApplicationCriticalityDao {
    ...
    @Override
    protected Class<ApplicationCriticality> getClassReference() {
        return ApplicationCriticality.class;
    }
